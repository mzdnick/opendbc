...
from opendbc.car.mazda.values import CAR, DBC, LKAS_LIMITS, PXM7_CRUISE_SPEED_PCM_FW_PREFIX, STEER_TO_ZERO_EPS_FW, MazdaFlags, MazdaSafetyFlags
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, is_release, docs) -> structs.CarParams:
    ...
    # Export CX-9s built on PXM7 PCMs encode CRZ_SPEED on a 196-per-km/h grid instead of
    # the shared 200; carstate rescales it so the published set speed matches the cluster.
