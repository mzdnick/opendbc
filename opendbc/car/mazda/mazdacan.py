...
def create_laneinfo_relay(cam_raw: int | None, steer_indicator: bool | None = None):
  ...
  # camera's: the dash cross-checks it against the camera's tracking traffic, and a
  # blanked field while the camera tracks faults the FSC (device-falsified 2026-09-08,
  # constant malfunction while steering quietly, clear the moment an alert lit)
