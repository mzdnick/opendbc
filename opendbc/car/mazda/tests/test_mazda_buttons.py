...
class TestCancelCarveOut:
  ...
  On the stock radar the same holds for a cruise openpilot never joined: SET with LKA off
  starts a stock-only ACC run (route 9ff65375 leg B), which the old 10 Hz CANCEL killed."""
